...
import { ITreeMap } from "./base/ITreeMap";

import { _MapTree } from "./base/tree/_MapTree";
...
export class TreeMap<Key, T>
	...
	implements ITreeMap<Key, T>
{
	/**
	 * @hidden
	 */
	private tree_: _MapTree<Key, T>;
	...
	public constructor(...args: any[])
	{
		// INIT MEMBERS
		super();
		this.tree_ = new _MapTree<Key, T>(this);
	 ...
	 * @inheritdoc
	 */
	public swap(obj: TreeMap<Key, T> | Container<Pair<Key, T>>): void
	{
	...
	implements ITreeMap<Key, T>
{
	 ...
	 * @inheritdoc
	 */
	public swap(obj: TreeMultiMap<Key, T> | Container<Pair<Key, T>>): void
	{
