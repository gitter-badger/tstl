import { ListContainer, ListIteratorBase } from "./base/ListContainer";
import { Container, ILinearContainer } from "./base/Container";
import { Iterator, ReverseIterator, ILinearIterator } from "./iterator";
 ...
 */
export class List<T>
	extends ListContainer<T, ListIterator<T>>
{
	...
	public swap(obj: List<T> | Container<T>): void
	{
		super.swap(obj);
	}
}
