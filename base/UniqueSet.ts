import { SetContainer, SetIterator, SetReverseIterator } from "./SetContainer";
	...
	extends SetContainer<T>
{
	 ...
	 * <p> Extract an element. </p>
	 *
	 * <p> Extracts the element pointed to by <i>key</i> and erases it from the {@link UniqueSet}. </p>
	 *
