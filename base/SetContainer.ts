	...
	implements IComparable<SetIterator<T>>
{
	 ...
	 */
	public constructor(source: SetElementList<T>, prev: SetIterator<T>, next: SetIterator<T>, val: T)
	{
	 ...
	 * @inheritdoc
	 */
	public source(): SetContainer<T>
	{
		return (super.source() as SetElementList<T>).get_associative();
	}
