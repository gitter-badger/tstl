...
import { ListContainer, ListIteratorBase } from "./ListContainer";
import { Iterator, ReverseIterator } from "./../iterator";

import { Pair, make_pair } from "./../utility";
import { IComparable, less, equal_to, hash } from "./../functional";
...
export class MapIterator<Key, T>
	extends ListIteratorBase<Pair<Key, T>>
	implements IComparable<MapIterator<Key, T>>
{
	 ...
	 */
	public constructor(source: MapElementList<Key, T>, prev: MapIterator<Key, T>, next: MapIterator<Key, T>, val: Pair<Key, T>)
	{
	 ...
	 * @hidden
	 */
	public source(): MapContainer<Key, T>
	{
		return (super.source() as MapElementList<Key, T>).get_associative();
	}
