import { Container, IDequeContainer } from "./Container";
import { Iterator, ReverseIterator, distance } from "./../iterator";
	...
	implements IDequeContainer<T>
{
	...
	public swap(obj: ListContainer<T, BidirectionalIterator> | Container<T>): void
	{
